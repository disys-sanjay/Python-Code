...
Sanjay=phone_Contacts("Sanjay","Sharma","9003085387","SanjaySharma12545@gmail.com","Family","06/04/2007")
Sanjay.open_phcontacts()
Sanjay.firstname_verification()
Sanjay.lastname_verification()
Sanjay.phonenumber_verification()
Sanjay.emailid_verification()
Sanjay.groups_verification()
Sanjay.dob_verification()
